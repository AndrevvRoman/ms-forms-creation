 ...
 */
final class Version20211002071949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE field (id INT AUTO_INCREMENT NOT NULL, id_form_fk_id INT NOT NULL, is_require TINYINT(1) NOT NULL, title VARCHAR(255) DEFAULT NULL, place_holder VARCHAR(255) DEFAULT NULL, input_type VARCHAR(255) NOT NULL, response_type VARCHAR(255) NOT NULL, INDEX IDX_5BF5455883BA3DC4 (id_form_fk_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
